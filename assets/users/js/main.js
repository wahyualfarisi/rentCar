...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src: document.URL+'/assets/users/img/slider-img/slider-img-1.jpg'
                },
                {
                    src: document.URL+'/assets/users/img/slider-img/slider-img-2.jpg'
                },
                {
                    src: document.URL+'/assets/users/img/slider-img/slider-img-3.jpg'
                },
                {
                    src: document.URL+'/assets/users/img/slider-img/slider-img-4.jpg'
                }
            ]
        }); //Home Page Two Slideshow
